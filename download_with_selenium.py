...
def get_image_links(main_keyword, supplemented_keywords, link_file_path, num_requested = 2000):
    ...
    with open(link_file_path, 'r') as rf:
        for link in rf:
            try:
                ...
                data = response.read()
                file_path = img_dir +main_keyword+ '_{0}.jpg'.format(count)
...
if __name__ == "__main__":
    # main_keywords = ['neutral', 'surprise', 'disgust', 'fear', 'happy', 'sad','angry']
    main_keywords = ['neutral', 'surprise', 'disgust', 'fear', 'happy', 'sad', 'angry']
    # main_keywords = ['disgust', 'fear', 'sad']
